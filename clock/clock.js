...
function drawHand(loc,isHour){
	//var angle = (Math.PI*2) * (loc/6) - Math.PI/2,
	var angle = (Math.PI*2)*(loc/60),
		handRadius = isHour?RADIUS - HAND_TURNCATION-HOUR_HAND_TURNCATION
							:RADIUS - HAND_TURNCATION;
...
function drawHands(){
	...
	drawHand(hour + (date.getMinutes()/60),true,0.5);
